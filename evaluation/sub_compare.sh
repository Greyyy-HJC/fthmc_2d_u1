...
#PBS -o /eagle/fthmc/run/fthmc_2d_u1/evaluation/logs/compare_hmc_L128_beta6_10240.log
...
python compare_fthmc.py --lattice_size 64 --n_configs 10 --beta 7 --train_beta 6 --step_size 0.06 --ft_step_size 0.05 --max_lag 200 --rand_seed 2008 --model_tag 'rnet' --save_tag 'rnet' --device 'cuda'
