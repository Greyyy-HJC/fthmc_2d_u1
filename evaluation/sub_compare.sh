...
#PBS -o /eagle/fthmc/run/fthmc_2d_u1/evaluation/logs/compare_fthmc_rnet_L64_b6_train_b4_4096.log
...
python compare_fthmc.py --lattice_size 64 --n_configs 4096 --beta 6.0 --train_beta 4.0 --step_size 0.06 --ft_step_size 0.05 --max_lag 200 --rand_seed 2008 --model_tag 'rnet' --save_tag 'rnet' --device 'cuda'
