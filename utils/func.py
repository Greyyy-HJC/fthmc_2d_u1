...
def plot_results(beta, therm_plaq_ls, plaq_ls, topological_charges, hamiltonians, autocorrelations, title_suffix=""):
    ...
    plt.title(f'Plaquette vs. Iteration', fontsize=fontsize)
    ...
    plt.title(f'Hamiltonian vs. Iteration', fontsize=fontsize)
    plt.xlabel('Iteration', fontsize=fontsize)
    ...
    plt.title(f'Topological Charge vs. Iteration', fontsize=fontsize)
    plt.xlabel('Iteration', fontsize=fontsize)
    ...
    plt.title(f'Autocorrelation {title_suffix}', fontsize=fontsize)
